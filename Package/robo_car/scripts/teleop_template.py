...
if __name__=="__main__":
    ...
    pub_right = rospy.Publisher('/robo_car/Front_right_wheel_motor/command', Float64, queue_size=10) # Add your topic here between ''. Eg '/my_robot/steering_controller/command'
    pub_left = rospy.Publisher('/robo_car/Front_left_wheel_motor/command', Float64, queue_size=10)
    pub_move = rospy.Publisher('/robo_car/Rear_wheel_motor/command', Float64, queue_size=10) # Add your topic for move here '' Eg '/my_robot/longitudinal_controller/command'
